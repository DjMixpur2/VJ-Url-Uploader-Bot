...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "8015124288:AAHer6UJIOn-m5FYtaLiQTsHzfKEbsAGRYM")
    ...
    TECH_VJ_HTTP_PROXY = "103.118.183.85"
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "770434685")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001933509863")) # your log channel id and make bot admin in log channel with full right 
